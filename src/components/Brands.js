...
const Brands = () => (
  <div className="container mx-auto flex flex-col mt-10 mb-2 py-4 px-8 items-center justify-between space-y-6">
    <h1 className='title text-center'>Our Technology Partners</h1>
    <Marquee>
